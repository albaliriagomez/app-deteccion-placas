...
class ResultadoVerificacionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final estado = data["estado"] ?? "No Registrado";

    final bool pagoVigente = estado == "Pago Vigente";
    final bool pagoVencido = estado == "Pago Vencido";
    final bool noRegistrado = estado == "No Registrado";

    /// SI HAY INFRACCION -> IR AUTOMATICAMENTE
    if (pagoVencido || noRegistrado) {
        ...
        child: Column(
          ...
          children: [
            ...
            _detailTile(
              ...
              "UBICACIÓN",
              registro["ubicacion"] ?? "Sin datos",
            ),

            const SizedBox(height: 40),

            /// BOTON NUEVA VERIFICACION
            ElevatedButton(
              onPressed: () {
